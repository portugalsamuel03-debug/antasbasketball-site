    ...
    return (
        <div className="px-6 pb-20 space-y-6">
            <div className="flex justify-between items-center">
                <div className="text-xs font-black uppercase tracking-widest text-gray-500">Galeria de Gestores</div>
            ...
            <div className="grid gap-6">
                {managers.map(manager => (
                    ...
                    >
                        ...
                        <div className="relative p-6 flex flex-col sm:flex-row gap-6 items-center sm:items-start text-center sm:text-left">
                            {/* Manager Image */}
                            <div className="w-24 h-24 rounded-full border-4 border-yellow-400 overflow-hidden shadow-xl flex-shrink-0 bg-gray-300">
                                {manager.image_url ? (
                ...
                {managers.length === 0 && (
                    <div className="text-center py-12 text-gray-500 text-sm">Nenhum gestor cadastrado.</div>
                )}
            </div>
