  ...
  return (
    <>
      <div
        ...
        className={`fixed inset-0 z-[80] overflow-y-auto animate-in slide-in-from-right duration-500 overscroll-behavior-y-contain ${isDarkMode ? "bg-black" : "bg-[#FDFBF4]"
          }`}
      >
        <div className={`max-w-md mx-auto min-h-screen flex flex-col relative pb-32 ${isDarkMode ? "bg-black" : "bg-[#FDFBF4]"}`}>
          ...
          <div
            className={`sticky top-0 z-[90] px-6 py-5 flex justify-between items-center border-b transition-all ${isDarkMode ? "bg-black/80 backdrop-blur-2xl border-white/5" : "bg-[#FDFBF4]/80 backdrop-blur-2xl border-[#0B1D33]/5"
              }`}
          >
            <div className="flex items-center gap-2">
              <button
                onClick={onBack}
                className={`p-2.5 -ml-2.5 rounded-full active:scale-90 transition-transform shadow-lg border ${isDarkMode ? "text-white bg-[#1a1a1a] border-white/5" : "text-[#0B1D33] bg-white border-[#0B1D33]/5"
                  }`}
              >
          ...
          <div className="relative w-full h-[380px] overflow-hidden">
            ...
            <div className="absolute bottom-10 px-8">
              <div className="flex items-center gap-3 mb-4">
                <span
                  className={`px-4 py-1.5 text-[10px] font-black rounded-full uppercase tracking-[0.2em] shadow-xl ${isDarkMode ? "bg-yellow-400 text-black" : "bg-[#0B1D33] text-white"
                    }`}
                >
                  {article.category}
                </span>
                <span
                  className={`text-[10px] font-black uppercase tracking-widest backdrop-blur-md px-3 py-1.5 rounded-full ${isDarkMode ? "bg-white/5 text-gray-400" : "bg-[#0B1D33]/5 text-[#0B1D33]"
                    }`}
                >
                  {article.readTime}
                </span>
